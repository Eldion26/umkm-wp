...
Route::get('/admin/user', [KelolaUserController::class, 'index'])->name('admin.kelolauser');
...
// Route::get('/SiDesa/SiDesa', function () {
//     return view('SiDesa.SiDesa');
// });

// Route::get('/SiDesa/layanan', function () {
//     return view('SiDesa.sidesa_layanan');
// });
