                ...
                <div class="max-w-[1320px] mx-auto px-6 py-4 flex items-center justify-between gap-6">
                    <div class="relative w-full max-w-md">
                        ...
                        <input
                            ...
                            placeholder="Cari produk, SKU, atau mitra..." type="text" />
                    </div>
            ...
            <div class="p-6 lg:p-xl max-w-[1320px] mx-auto w-full space-y-gutter">
                <section class="flex flex-col lg:flex-row lg:items-end justify-between gap-4">
                    <div>
                        ...
                        <p class="font-body-md text-slate-500">Pantau katalog, stok, harga, dan status publikasi produk
                            UMKM.</p>
                    </div>
                ...
                <section class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-gutter">
                    <div class="bg-white p-6 rounded-xl border border-slate-100 shadow-sm">
                        <div class="flex justify-between items-start">
                            <div class="p-2 bg-emerald-50 text-emerald-700 rounded-lg"><span
                                    class="material-symbols-outlined">inventory_2</span></div>
                            <span class="text-emerald-600 text-xs font-semibold">+18 bulan ini</span>
                        </div>
                        <p class="mt-4 text-slate-500 font-label-bold uppercase text-[10px] tracking-wider">Total Produk
                        </p>
                        <h2 class="text-h3 font-h3 text-slate-900">248</h2>
                    </div>
                    <div class="bg-white p-6 rounded-xl border border-slate-100 shadow-sm">
                        <div class="flex justify-between items-start">
                            <div class="p-2 bg-orange-50 text-orange-700 rounded-lg"><span
                        ...
                        <p class="mt-4 text-slate-500 font-label-bold uppercase text-[10px] tracking-wider">Draft &
                            Review</p>
                        <h2 class="text-h3 font-h3 text-slate-900">14</h2>
                    </div>
                    <div class="bg-white p-6 rounded-xl border border-slate-100 shadow-sm">
                        <div class="flex justify-between items-start">
                            <div class="p-2 bg-sky-50 text-sky-700 rounded-lg"><span
                                    class="material-symbols-outlined">storefront</span></div>
                            <span class="text-sky-600 text-xs font-semibold">96 mitra</span>
                        </div>
                        <p class="mt-4 text-slate-500 font-label-bold uppercase text-[10px] tracking-wider">Produk Aktif
                        </p>
                        <h2 class="text-h3 font-h3 text-slate-900">221</h2>
                    </div>
                    <div class="bg-white p-6 rounded-xl border border-slate-100 shadow-sm">
                        <div class="flex justify-between items-start">
                            <div class="p-2 bg-red-50 text-red-700 rounded-lg"><span
                                    class="material-symbols-outlined">warning</span></div>
                            <span class="text-red-600 text-xs font-semibold">Segera isi</span>
                        </div>
                        <p class="mt-4 text-slate-500 font-label-bold uppercase text-[10px] tracking-wider">Stok Menipis
                        </p>
                ...
                <section
                    ...
                    <div class="relative w-full xl:max-w-sm">
                        ...
                        <input
                            ...
                            placeholder="Cari nama produk..." type="text" />
                    </div>
                        ...
                        <table class="w-full text-left border-collapse min-w-[960px]">
                            ...
                            <tbody class="divide-y divide-slate-100">
                                @php
                                    $products = [
                                        [
                                            'name' => 'Syal Sutra Batik Tulis Solo',
                                            'seller' => 'Batik Lestari',
                                            'cat' => 'Fashion Lokal',
                                            'price' => 'Rp 450.000',
                                            'stock' => 34,
                                            'status' => 'Aktif',
                                        ...
                                        [
                                            'name' => 'Keripik Tempe Organik 200g',
                                            'seller' => 'Berkah Jaya Food',
                                            'cat' => 'Makanan & Minuman',
                                            'price' => 'Rp 28.000',
                                            'stock' => 8,
                                            'status' => 'Review',
                                        ...
                                        [
                                            'name' => 'Set Cangkir Keramik Stoneware',
                                            'seller' => 'Tanah Rupa Studio',
                                    ...
                                    <tr class="hover:bg-slate-50 transition-colors">
                                        <td class="px-6 py-4">
                                            <div class="flex items-center gap-3">
                                                <img class="w-12 h-12 rounded-xl object-cover bg-slate-100"
                                                    alt="{{ $product['name'] }}" src="{{ $product['img'] }}" />
                                                <div>
                                                    <p class="font-label-bold text-on-surface">{{ $product['name'] }}
                                                    </p>
                                        ...
                                        <td class="px-6 py-4 font-body-sm text-on-surface-variant">
                                            {{ $product['cat'] }}</td>
                                        <td class="px-6 py-4 font-label-bold text-on-surface">{{ $product['price'] }}
                                        </td>
                                        <td class="px-6 py-4">
                                            <span
                                                class="font-label-bold {{ $product['stock'] <= 8 ? 'text-red-700' : 'text-on-surface' }}">{{ $product['stock'] }}</span>
                                        </td>
                                        <td class="px-6 py-4">
