...
<body class="bg-background font-body-md text-on-surface flex min-h-screen">
    ...
    <main class="flex-1 overflow-y-auto bg-background">
        ...
        <header class="sticky top-0 z-10 bg-white/80 backdrop-blur-md px-xl py-lg flex justify-between items-center">
            <div>
                ...
                <p class="font-body-sm text-body-sm text-outline">Lengkapi detail produk Anda untuk mulai berjualan di
                    UMKM Digital.</p>
            </div>
            <div class="flex items-center gap-md">
                <button
                    class="px-xl py-sm font-button text-button border border-outline text-outline rounded-full hover:bg-slate-50 active:scale-95 transition-all">Batal</button>
                <button
                    class="px-xl py-sm font-button text-button bg-primary text-on-primary rounded-full hover:opacity-90 active:scale-95 transition-all shadow-sm">Simpan
                    Produk</button>
            </div>
        </header>
        <div class="max-w-[1000px] mx-auto px-xl py-xl">
            <div class="grid grid-cols-12 gap-gutter">
                ...
                <div class="col-span-12 lg:col-span-7 space-y-lg">
                        ...
                        <div class="space-y-md">
                            <div>
                                <label class="block font-label-bold text-label-bold text-on-surface-variant mb-xs">Nama
                                    Produk</label>
                                <input
                                    class="w-full p-md border border-slate-300 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all placeholder:text-slate-400"
                                    placeholder="Contoh: Keripik Tempe Organik 200g" type="text" />
                                <p class="mt-xs text-[12px] text-outline">Gunakan nama yang jelas dan menarik pelanggan.
                                </p>
                            </div>
                            <div class="grid grid-cols-2 gap-md">
                                <div>
                                    <label
                                        class="block font-label-bold text-label-bold text-on-surface-variant mb-xs">Kategori</label>
                                    <div class="relative">
                                        <select
                                            class="w-full p-md border border-slate-300 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none appearance-none bg-white transition-all">
                                ...
                                <div>
                                    <label
                                        class="block font-label-bold text-label-bold text-on-surface-variant mb-xs">Harga
                                        (Rp)</label>
                                    <input
                                        class="w-full p-md border border-slate-300 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all placeholder:text-slate-400"
                            ...
                            <div>
                                <label
                                    class="block font-label-bold text-label-bold text-on-surface-variant mb-xs">Deskripsi
                                    Produk</label>
                                <textarea
                                    class="w-full p-md border border-slate-300 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all placeholder:text-slate-400 resize-none"
                                    placeholder="Ceritakan keunggulan produk Anda..." rows="6"></textarea>
                            </div>
                        </div>
                    </section>
                    <!-- Inventory Section -->
                    <section class="bg-white p-xl rounded-xl shadow-[0_8px_24px_rgba(0,0,0,0.05)] space-y-lg">
                        ...
                        <div class="grid grid-cols-2 gap-md">
                            <div>
                                <label
                                    class="block font-label-bold text-label-bold text-on-surface-variant mb-xs">Jumlah
                                    Stok</label>
                                <input
                                    class="w-full p-md border border-slate-300 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none"
                                    type="number" value="0" />
                            </div>
                            <div>
                                <label class="block font-label-bold text-label-bold text-on-surface-variant mb-xs">SKU
                                    (Opsional)</label>
                                <input
                                    class="w-full p-md border border-slate-300 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none"
                                    placeholder="PROD-001" type="text" />
                            </div>
                        </div>
                    </section>
                </div>
                ...
                <div class="col-span-12 lg:col-span-5 space-y-lg">
                    <section
                        class="bg-white p-xl rounded-xl shadow-[0_8px_24px_rgba(0,0,0,0.05)] space-y-lg sticky top-xl">
                        <div class="flex justify-between items-center">
                            <h3 class="font-h3 text-h3 text-on-surface">Foto Produk</h3>
                            <span
                                class="text-body-sm font-label-bold text-primary bg-primary/10 px-sm py-xs rounded">Wajib</span>
                        </div>
                        <!-- Drag and Drop Area -->
                        <div
                            class="group relative border-2 border-dashed border-slate-200 hover:border-primary rounded-xl p-xl flex flex-col items-center justify-center text-center cursor-pointer transition-all bg-slate-50 hover:bg-emerald-50/30">
                            <input class="absolute inset-0 opacity-0 cursor-pointer" multiple="" type="file" />
                            <div
                                class="w-16 h-16 bg-white rounded-full shadow-sm flex items-center justify-center mb-md group-hover:scale-110 transition-transform">
                        ...
                        <div class="grid grid-cols-3 gap-md">
                            <div
                                ...
                                <img class="w-full h-full object-cover"
                                    data-alt="close up shot of handcrafted ceramic bowl with earth tone glaze on a wooden table"
                                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuA3zDcbmGbtUfon80rr7ZrSHyWt3hWbbLGL7kCtDHWhaBB5grWQ3gOAmyUxJEs0uiwI6XbbM1bCFrnutgez_JS8GmgB41bftDmXbTx5Vis8WykPmv-7gG0Q25FyCVLiZ5yrwTGO0HZM_HGKtWi7K26mWZsGqd9U5huG9Low9EOqEFIbFzgggisyf-a_8ZL00og9wGeYc1eGpRKMCXEG96bHrlimRooDw4WPQpsSAE_6WWS88FXq5s-JDwtIrqizjV25FgqmZZmGJ-XU" />
                                <div
                                    class="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                                    <button
                                        class="bg-red-500 text-white p-xs rounded-full hover:scale-110 transition-transform">
                                        <span class="material-symbols-outlined text-sm">delete</span>
                                    </button>
                                </div>
                                <div
                                    class="absolute bottom-0 left-0 right-0 bg-primary/90 text-white text-[10px] py-1 text-center font-label-bold">
                                    UTAMA</div>
                            </div>
                            <div
                                class="relative group aspect-square rounded-lg overflow-hidden border border-slate-200">
                                <img class="w-full h-full object-cover"
                                    data-alt="artisanal woven basket showing intricate texture and natural fibers"
                                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuBQMg8kRJaEWbAtC3ibrdP5vd0X7n-stqaR9R6gyACa_QIawu8PqCnxWRxhvlYDOwjosRk8N1SEoyHQ-NaYjv9q5s1hL3tDGlvSqeI89T0TUVyEEydbVAckR4zsS5ROELb4438thmoS4Qsuhe9dn8OHQF3TJhy9zbm6Ah_n6uTuPYdBikSlySwDFur574jpziLyTY0tfdlhOL_ZiEbGv9kSdgGUegNvpGufuvucNajrlMm-hPhykov9h2yCu6IxxuacdkXHl7_6KYrY" />
                                <div
                                    class="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                                    <button
                                        class="bg-red-500 text-white p-xs rounded-full hover:scale-110 transition-transform">
                            ...
                            <div
                                class="aspect-square rounded-lg border border-dashed border-slate-300 flex items-center justify-center text-slate-400 hover:text-primary hover:border-primary transition-colors cursor-pointer">
                        ...
                        <div class="p-md bg-secondary-fixed rounded-xl flex gap-md">
                            ...
                            <div>
                                ...
                                <p class="text-[12px] text-on-secondary-fixed-variant leading-tight mt-xs">Gunakan
                                    pencahayaan alami dan latar belakang polos untuk menonjolkan detail produk Anda.</p>
                            </div>
                        </div>
                    </section>
                </div>
    ...
    <footer
        class="md:hidden fixed bottom-0 w-full bg-white border-t border-slate-200 p-md flex justify-between items-center z-50">
        <button class="px-lg py-sm font-button text-body-sm border border-outline rounded-full">Batal</button>
        <button
            class="px-xl py-sm font-button text-body-sm bg-primary text-on-primary rounded-full shadow-md">Simpan</button>
    </footer>
</body>
